...
describe('Store', () => {
  ...
  xit('should display results when necessary data is provided', () => {
  ...
  xit('should not display results when necessary data is not provided', () => {
    const store = createStore(rootReducer, initialState);
  ...
  xit('should handle a flurry of actions', () => {
    const store = createStore(rootReducer, initialState);
